...
describe('cookie.serialize(name, value)', function () {
  ...
  it('should serialize valid name with extended characters', function () {
    assert.equal(cookie.serialize('foo/bar', 'baz'), 'foo/bar=baz')
    assert.equal(cookie.serialize('foo@bar', 'baz'), 'foo@bar=baz')
    assert.equal(cookie.serialize('foo:bar', 'baz'), 'foo:bar=baz')
  })
...
describe('cookie.serialize(name, value, options)', function () {
  ...
  describe('with "encode" option', function () {
    ...
    it('should serialize valid values with extended characters', function () {
      assert.deepEqual(cookie.serialize('foo', 'foo,bar', {
